      ...
      <div className="container">
        ...
        >
          <div className="swiper-wrapper">
            ...
            <SwiperSlide className="swiper-slide">
              <div className="gallery-image">
                <img src="assets/img/gallery/02.webp" alt="gallery-img" />
                <div className="icon">
                  <Link href="/gallery">
                    <i className="far fa-link" />
                  </Link>
            ...
            <SwiperSlide className="swiper-slide">
              <div className="gallery-image">
                <img src="assets/img/gallery/04.webp" alt="gallery-img" />
                <div className="icon">
                  <Link href="/gallery">
                    <i className="far fa-link" />
                  </Link>
            ...
            <SwiperSlide className="swiper-slide">
              <div className="gallery-image">
                <img src="assets/img/gallery/05.webp" alt="gallery-img" />
                <div className="icon">
                  <Link href="/gallery">
                    <i className="far fa-link" />
                  </Link>
